 ...
 */
public class SwitchDetailBasePager extends BaseLeftMenuPager {
    ...
    public SwitchDetailBasePager(Context context) {
        super(context);
...
//            }
             ...
             * 使用ImageLoad
             */
            ImageLoader.getInstance().displayImage(requestUrl, viewHodle.image, options, animateFirstListener);
